...
extension AppDelegate: UNUserNotificationCenterDelegate {
  func userNotificationCenter(_ center: UNUserNotificationCenter, willPresent notification: UNNotification, withCompletionHandler completionHandler: @escaping (UNNotificationPresentationOptions) -> Void) {
    print("Received Notification on: \(notification.date)\nPaylod Title: \(notification.request.content.title)\nPayload Message: \(notification.request.content.body)\nPayload: \(notification.request.identifier)")
  }
  
  func userNotificationCenter(_ center: UNUserNotificationCenter, didReceive response: UNNotificationResponse) async {
    print("Response Body: \(response.notification.request.content.body)")
  }
}
